...
-- INSERT INTO user_role(ROLE_ID,USER_ID) VALUES(1,8);
 ...
 INSERT INTO CART(CART_ID,REQUISITION_NO,PORT_ID,COMPANY_ID,REQUEST_DATE,RELEASE_DATE,PORT_SOURCE,PORT_DESTINATION,REQUESTED_QUANTITY,STATUS,PICKUP_DATE,NOTE) values(1,101,3,1, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'CHSNN','USVIH',5,1,'2017-07-01','dsfsdgf');
 INSERT INTO CART(CART_ID,REQUISITION_NO,PORT_ID,COMPANY_ID,REQUEST_DATE,RELEASE_DATE,PORT_SOURCE,PORT_DESTINATION,REQUESTED_QUANTITY,STATUS,PICKUP_DATE,NOTE) values(2,102,2,2, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'INPHB','USVIH',10,1,'2017-07-05','edgrh');
 INSERT INTO CART(CART_ID,REQUISITION_NO,PORT_ID,COMPANY_ID,REQUEST_DATE,RELEASE_DATE,PORT_SOURCE,PORT_DESTINATION,REQUESTED_QUANTITY,STATUS,PICKUP_DATE,NOTE) values(3,103,2,2, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'INPHB','USVIH',4,1,'2017-07-05','efrgz');
 INSERT INTO CART(CART_ID,REQUISITION_NO,PORT_ID,COMPANY_ID,REQUEST_DATE,RELEASE_DATE,PORT_SOURCE,PORT_DESTINATION,REQUESTED_QUANTITY,STATUS,PICKUP_DATE,NOTE) values(4,104,2,1, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'INPHB','USVIH',10,1,'2017-07-05','eyuitr');
