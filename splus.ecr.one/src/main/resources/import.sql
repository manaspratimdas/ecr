...
-- INSERT INTO user_role(ROLE_ID,USER_ID) VALUES(1,8);
 ...
 INSERT INTO CART(CART_ID,REQUISITION_NO,PORT_ID,COMPANY_ID,REQUEST_DATE,RELEASE_DATE,PORT_SOURCE,PORT_DESTINATION,REQUESTED_QUANTITY,STATUS,PICKUP_DATE,NOTE) values(1,101,3,1, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'CHSNN','USVIH',5,1,'2017-07-01','note1');
 INSERT INTO CART(CART_ID,REQUISITION_NO,PORT_ID,COMPANY_ID,REQUEST_DATE,RELEASE_DATE,PORT_SOURCE,PORT_DESTINATION,REQUESTED_QUANTITY,STATUS,PICKUP_DATE,NOTE) values(2,102,2,2, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'INPHB','USVIH',10,1,'2017-07-05','note2');
 INSERT INTO CART(CART_ID,REQUISITION_NO,PORT_ID,COMPANY_ID,REQUEST_DATE,RELEASE_DATE,PORT_SOURCE,PORT_DESTINATION,REQUESTED_QUANTITY,STATUS,PICKUP_DATE,NOTE) values(3,103,2,2, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'CHSNN','USVIH',4,1,'2017-07-05','note3');
 INSERT INTO CART(CART_ID,REQUISITION_NO,PORT_ID,COMPANY_ID,REQUEST_DATE,RELEASE_DATE,PORT_SOURCE,PORT_DESTINATION,REQUESTED_QUANTITY,STATUS,PICKUP_DATE,NOTE) values(4,104,2,1, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'INPHB','USVIH',10,1,'2017-07-05','note4');

 
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,1);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,5);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,3);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,22);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,20);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,21);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,25);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,40);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,41);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(1,61);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,2);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,16);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,7);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,30);
  INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,31);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,32);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,45);
  INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,52);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,54);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(2,60);
  INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(3,30);
  INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(4,31);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(3,32);
 INSERT INTO CART_CONTAINER(CART_ID,CONTAINER_ID) values(4,45);